...
const defaultEvents = [{
    id: 1,
    start: '2023-05-21T00:00',
    end: '2023-05-24T00:00',
    title: 'Alice OFF',
    allDay: true,
    color: '#67ab0d'
}, {
...
function Calender() {
    ...
    const saveEvent = React.useCallback(() => {
        ...
        if (isEdit) {
            ...
            // ...
            console.log(newEv)
            axios.post('/api/updateEvent', newEv).then(()=>{
              toast({
            ...
            // ...
            console.log(newEv.start);
            console.log(newEv.end);
            axios.post('/api/addEvent', newEv).then(()=>{
              toast({
    ...
    const deleteEvent = React.useCallback((event) => {
        ...
        axios.post('/api/deleteEvent', event).then(()=>{
          toast({message:"Event Deleted Successfully", color:"success"})
        }).catch((error)=>{
          console.log(error);
          toast({message:"An Error Occured", color: "danger"})
        })
    }, [myEvents]);
    ...
    const onEventUpdated = React.useCallback((args) => {
        ...
        axios.post('/api/updatednd', args.event).then(()=>{
          toast({
            message:"Event Updated Successfully",
            color: 'success'
          })
